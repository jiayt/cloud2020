...
import com.czinwen.springcloud.alibaba.myhandler.CustomerBlockHandler;
...
public class RateLimitController {
    ...
    public CommonResult customerBlockHandler(){
        return new CommonResult(200,"自定义",new Payment(2020,"serial003"));
    }
}
